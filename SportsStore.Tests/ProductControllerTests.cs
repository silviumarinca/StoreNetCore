...
namespace SportsStore.Tests
{
    public class ProductControllerTests
    {
        ...
        public void Can_Use_Repository()
        {
            ...
            mock.Setup(mock=>mock.Products).Returns((
                new Product[]{
                    new Product{ProductID = 1, Name = "P1"},
                    new Product{ProductID = 2, Name ="P2"}
                 }).AsQueryable<Product>());
            HomeController controller = new HomeController(mock.Object);
            ProductsListViewModel pvm = controller.Index(null)
                            .ViewData.Model as ProductsListViewModel;
            IEnumerable<Product> result = pvm.Products.ToArray();
        ...
        public void Can_Paginate(){
            Mock<IStoreRepository> mock = new Mock<IStoreRepository>();
            mock.Setup(mk => mk.Products).Returns((new Product[]{
              new Product{ ProductID = 1, Name="P1"}
            }).AsQueryable<Product>());
            HomeController homeController = new HomeController(mock.Object);
            ProductsListViewModel pvm = homeController.Index(null,1).ViewData.Model as ProductsListViewModel;
            var result = pvm.Products.ToList();
            Product[] prodArray = result.ToArray();
        ...
        public void Can_FilterProducts()
        {
            ...
            HomeController hCtrl = new HomeController(mock.Object);
            hCtrl.PageSize=6;
            Product[] result = (hCtrl.Index("Cat2",1).ViewData.Model as ProductsListViewModel).Products.ToArray();
